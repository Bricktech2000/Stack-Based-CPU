  ...
  for in_byte in in_bytes {
    ...
    if load_next == true {
      ...
      match op_code {
        ...
        0x31 => { memory[stack_pointer as usize + 1] = memory[stack_pointer as usize + 1] | memory[stack_pointer as usize]; stack_pointer += 1; memory[stack_pointer as usize - 1] = 0; },
        0x32 => { memory[stack_pointer as usize + 1] = memory[stack_pointer as usize + 1] & memory[stack_pointer as usize]; stack_pointer += 1; memory[stack_pointer as usize - 1] = 0; },
        0x33 => { memory[stack_pointer as usize + 1] = memory[stack_pointer as usize + 1] ^ memory[stack_pointer as usize]; stack_pointer += 1; memory[stack_pointer as usize - 1] = 0; },
